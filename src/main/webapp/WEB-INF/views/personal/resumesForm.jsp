				...
				<div class="about-content">
					...
					<p class="desc">
						<input id="usersName" type="text" class="form-control"
							style="width: 300px" placeholder="${personalInfoPS.personalName}"
							readonly> <br /> <input id="phoneNumber" type="text"
						...
						<input id="address" type="text" class="form-control"
							style="width: 600px"
							placeholder="${personalInfoPS.personalAddress}" readonly>
