		...
		<c:forEach var="jobPostingBoardList" items="${jobPostingBoardList}">
			<tr>
				...
				<td>	
					...
					<a href="/company/jobPostingBoard/${jobPostingBoardList.jobPostingBoardId}">
	...
	<div class="d-flex justify-content-center">
		<ul class="pagination">
		   <li class='page-item ${paging.first ? "disabled" : " "}'>
		   		<a class="page-link" href="?page=${paging.currentPage-1}&keyword=${paging.keyword}">Prev</a>
		   </li>
		   ...
		   <li class='page-item ${paging.last ? "disabled" : " "}'>
		   		<a class="page-link" href="?page=${paging.currentPage+1}&keyword=${paging.keyword}">Next</a>
		   </li>
		</ul>	
	</div>
