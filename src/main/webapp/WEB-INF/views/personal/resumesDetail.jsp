		...
		<div class="row">
			<div class="col-lg-4" data-aos="fade-right">
				...
				<div class="btn-update">
					<a href="/personal/resumes/update/${detailResumesDtoPS.resumesId}"><button id="btnUpdate" type="button" class="btn btn-primary"
						style="background-color: rgba(0, 195, 98, 255); border: none; margin-top: 100px; margin-left: 90px">이력서 수정</button></a>
				</div>
			</div>
