        ...
        <section id="about" class="about">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                    <h2>이력서</h2>
                    <p class="fst-italic">
                        이력서 제목 : ${detailResumesDtoPS.resumesTitle}
                    </p>
                    <div class="row">
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>이름 :</strong>
                                    <span>${detailResumesDtoPS.personalName}</span>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong>이메일 :</strong>
                                    <span>${detailResumesDtoPS.personalEmail}</span>
                                </li>
                                <li><i class="bi bi-chevron-right"></i> <strong>경력 :</strong> <span>
                                        <c:choose>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>학력:</strong>
                                    <span>${detailResumesDtoPS.personalEducation}</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>희망 근무 지역 :</strong>
                                    <span>${detailResumesDtoPS.resumesPlace}</span>
                                </li>
                    ...
                    <p>
                        자기소개문 : <textarea class="form-control" id="resumesIntroduce" rows="8"
