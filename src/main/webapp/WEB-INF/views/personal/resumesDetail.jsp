	...
	<section id="about" class="about">
		<div class="row">
			<div class="col-lg-4" data-aos="fade-right">
				...
				<div class="btn-update">
					<a href="/personal/resumes/update/${detailResumesDtoPS.resumesId}"><button id="btnUpdate"
							...
							style="background-color: rgba(0, 195, 98, 255); border: none; margin-top: 100px; margin-left: 90px">이력서
							수정</button></a>
				</div>
			</div>
			...
			<div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
				<h2>이력서</h2>
				<p class="fst-italic">이력서 제목 : ${detailResumesDtoPS.resumesTitle}</p>
				<div class="row">
					<div class="col-lg-6">
						<ul>
							<li><i class="bi bi-chevron-right"></i> <strong>이름 :</strong> <span>${detailResumesDtoPS.personalName}</span></li>
							<li><i class="bi bi-chevron-right"></i> <strong>이메일 :</strong> <span>${detailResumesDtoPS.personalEmail}</span></li>
							<li><i class="bi bi-chevron-right"></i> <strong>경력 :</strong> <span> <c:choose>
							...
							<li><i class="bi bi-chevron-right"></i> <strong>학력:</strong> <span>${detailResumesDtoPS.personalEducation}</span></li>
						</ul>
					</div>
					<div class="col-lg-6">
						<ul>
							<li><i class="bi bi-chevron-right"></i> <strong>연락처 :</strong> <span>
									${detailResumesDtoPS.personalPhoneNumber}</span></li>
							<li><i class="bi bi-chevron-right"></i> <strong>희망 근무 지역 :</strong> <span>${detailResumesDtoPS.resumesPlace}</span></li>
							<li><i class="bi bi-chevron-right"></i> <strong>관심분야:</strong> <span> <c:choose>
							...
							<li><i class="bi bi-chevron-right"></i> <strong>링크</strong> <span><a
									href="${detailResumesDtoPS.portfolioSource}" style="font-size: 20px">
