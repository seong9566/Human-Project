            ...
            <div class="btn-update" style="margin-top: 5px;">
               <c:choose>
                  <c:when test="${ empty personalLike }">
                     <button id="btnlike" type="button" class="btn btn-primary" style=" color: white; background-color: rgba(0, 195, 98, 255); border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;">좋아요</button>
                  </c:when>
                  <c:otherwise>
                     <button id="btnlike" type="button" class="btn btn-primary" style=" color: white; background-color: rgba(0, 195, 98, 255); border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;">좋아요취소</button>
                  </c:otherwise>
               </c:choose>
               <button id="btnapply" type="button" class="btn btn-primary" style=" color: white; background-color: rgba(0, 195, 98, 255); border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;">연락하기</button>
            </div>
         </div>
