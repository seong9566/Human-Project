...
<div class="container">
    ...
    <c:forEach var="jobPostingBoard" items="${jobPostingBoardList}">
        <input id="jobPostingBoardId" type="hidden" value="${jobPostingBoard.jobPostingBoardId}">
        ...
        <div class="container p-5 my-4 border">
            ...
            <div class="mb-3" style="margin-left: 1000px;">
                <button id="btnDelete" onclick="deleteById(${jobPostingBoard.jobPostingBoardId});" type="button"
                    class="btn btn-primary" style="background-color: red; border: none;">삭제하기</button>
            </div>
        </div>
    ...
    <div class="d-grid gap-2 col-2 mx-auto">
        <button id="btnSaveForm" type="button" class="btn btn-primary"
            style="background-color: rgba(0, 195, 98, 255); border: none; margin-bottom: 10px; margin-top: 10px; margin-bottom: 20px;">공고등록하러가기</button>
    </div>
</div>
<script>
