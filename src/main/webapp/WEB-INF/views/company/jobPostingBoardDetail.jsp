		...
		<div class="row">
			<div class="col-lg-4" data-aos="fade-right">
				<img
					...
					src="/img/${jobPostingPS.jobPostingBoardPicture}"
					class="img-fluid" alt="#">
				<div class="btn-update">
					<button id="btnUpdateForm" type="button" class="btn btn-primary" style="background-color: rgba(0, 195, 98, 255); border: none; margin-top: 130px; margin-left: 30px">채용
						공고 수정</button>
				</div>
			</div>
