				...
				<ul class="navbar-nav" style="width: 100%">
					<c:choose>
						...
						<c:when test="${principal.companyId != null}">
							<li class="nav-item"><a class="nav-link" href="/recommend">관심
									이력서 보기</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/company/jobPostingBoardList"> 공고관리</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/company/inform">기업정보</a></li>
							...
							<li class="nav-item fa-regular fa-bell nav-link"
								...
								onclick="iconchangToRead()"></li>
							<li style="display: none;" id="userId"
								value="${principal.usersId}"></li>
						</c:when>
						<c:otherwise>
							<li class="nav-item"><a class="nav-link"
								href="/personal/info">내정보</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/personal/resumesForm">이력서작성하기</a></li>
							<li class="nav-item"><a class="nav-link"
								href="/personal/myresumesList">내이력서목록보기</a></li>
