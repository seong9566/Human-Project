...
public class Users {
	...
	public void updateCompanyUser(CompanyUserUpdateDto companyUserUpdateDto) {
		this.loginId = companyUserUpdateDto.getLoginId();
		this.loginPassword= companyUserUpdateDto.getLoginPassword();
	}
}
